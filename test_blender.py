...
if __name__ == "__main__":
    ...
    if args:
        ...
        # --- DYNAMIC DISK SAVE BLOCK ---
        # Converts "payload_name.json" straight into a permanent "output_name.blend" file
        output_name = payload_path.replace("payload_", "output_").replace(".json", ".blend")
        bpy.ops.wm.save_as_mainfile(filepath=output_name)
        print(f"[+] Production Pipeline complete! File saved as: {output_name}")
    else:
